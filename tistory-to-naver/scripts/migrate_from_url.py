...
# Sidecar file consumed by _lib/inject_code_blocks.py (pass 2: native code components)
...
# <repo>/blog/scripts/paste_to_naver.py so this script and the /blog
...
def split_content_into_chunks(soup, source_url=None, published_iso=None, tags=None):
    ...
    try:
        ...
        if code_blocks:
            ...
            print("[CODE] after pasting finishes, run: python3 _lib/inject_code_blocks.py")
    except OSError as e:
